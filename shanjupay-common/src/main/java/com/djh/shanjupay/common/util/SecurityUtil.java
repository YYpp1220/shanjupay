...
import com.djh.shanjupay.common.config.ApplicationContextHelper;
...
public class SecurityUtil {
	...
	/*public static Long getMerchantId(Long tenantId){
		MerchantServiceImpl merchantService = ApplicationContextHelper.getBean(MerchantServiceImpl.class);
